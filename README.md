...
> ⚠️ **Важно для Workflow Task 2**
>
> Для корректной работы воркфлоу **Task 2 (Autoretry / State Machine)** необходимо также
> импортировать дополнительный workflow **Nano Banana Mock**.
>
> Этот workflow эмулирует внешний Nano Banana API и используется HTTP-node внутри Task 2.
> Без него выполнение автоповторов генерации завершится ошибкой.
